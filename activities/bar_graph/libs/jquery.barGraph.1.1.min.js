...
return maxvalue;};doGraph=function(el){arr=opts[el.id];data=$.fn.jqBarGraph.getItemFromDom($(el));if(data==undefined){$(el).html('There is not enought data for graph');return;}
...
this.each(function()
{
  ...
  {
    barSpace:10,width:400,height:300,color:'#000000',
    colors:false,lbl:'',sort:false,position:'bottom',prefix:'',postfix:'',
    animate:true,speed:1.5,legendWidth:100,legend:false,legends:false,type:false,
    showValues:true,showValuesColor:'#fff',title:false
  };

  $.fn.jqBarGraph.getItemFromDom = function(el) {
     var list = [];
...
function sortNumberAsc(a,b){if(a[0]<b[0])return-1;if(a[0]>b[0])return 1;return 0;}
